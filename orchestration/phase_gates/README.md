...
2. **Run gate**: `python orchestration/phase_gates/gate_runner.py . X`
3. **Check result**:
...
python orchestration/phase_gates/gate_runner.py . --status
```
...
result = subprocess.run(
    ["python3", "orchestration/phase_gates/gate_runner.py", ".", "5"],
    cwd=project_root
)

...
**Name**: webview_integration  
**Type**: library  
**Level**: 2 (dependency level)  
**Description**: WebView wrapper with platform-specific implementations  
**Token Budget**: 12,000 / 70,000 (optimal)

## Your Boundaries

**Your Working Directory**: `components/webview_integration/`

**You CAN:**
- ✅ Work in `components/webview_integration/` directory
...
**Current Estimate**: 12,000 tokens  
...
```
[webview_integration] Brief description

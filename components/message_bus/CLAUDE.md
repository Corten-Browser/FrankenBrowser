...
**Description**: Message bus implementation for component communication  
**Token Budget**: 8,000 / 70,000 (optimal)

## Your Boundaries

**Your Working Directory**: `components/message_bus/`

**You CAN:**
- ✅ Work in `components/message_bus/` directory
...
2. **MessageSender Trait**
   - send(message: BrowserMessage) -> Result<()>
   - Thread-safe (Send + Sync)

3. **MessageHandler Trait**
   - handle(message: BrowserMessage) -> Result<()>
   - Async-compatible

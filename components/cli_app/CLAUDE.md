...
**Name**: cli_app  
**Type**: application  
**Level**: 4 (dependency level)  
**Description**: Main application entry point and wiring  
**Token Budget**: 3,000 / 70,000 (optimal)

## Your Boundaries

**Your Working Directory**: `components/cli_app/`

**You CAN:**
- ✅ Work in `components/cli_app/` directory
...
- `browser_shell` (import via Cargo workspace)

**Import Example**:
```rust
  use browser-shell::*;  // Import from browser_shell
```
...
3. **Component Wiring**
   ...
   - Set up message bus
   - Initialize network, adblock, browser core
   - Start UI shell

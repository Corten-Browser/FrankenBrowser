...
**Description**: HTTP client, request handling, cache, and cookies  
**Token Budget**: 12,000 / 70,000 (optimal)

## Your Boundaries

**Your Working Directory**: `components/network_stack/`

**You CAN:**
- ✅ Work in `components/network_stack/` directory
...
```
[network_stack] Brief description

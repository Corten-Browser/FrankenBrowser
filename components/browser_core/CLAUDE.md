...
**Name**: browser_core  
**Type**: library  
**Level**: 2 (dependency level)  
**Description**: Browser engine, navigation, history, and bookmarks  
**Token Budget**: 10,000 / 70,000 (optimal)

## Your Boundaries

**Your Working Directory**: `components/browser_core/`

**You CAN:**
- ✅ Work in `components/browser_core/` directory
...
1. **BrowserEngine Struct**
   - Navigation management
   - History tracking
   - Bookmarks management
   - Integration with network and message bus

2. **Navigation**
   - navigate(tab_id: u32, url: Url) -> Result<()>
   - go_back(tab_id: u32) -> Result<()>
   - go_forward(tab_id: u32) -> Result<()>
   - reload(tab_id: u32) -> Result<()>

3. **History**
   - SQLite database storage
   - Add, query, delete entries
   - Search functionality

4. **Bookmarks**
   - SQLite database storage
   - Add, remove, organize bookmarks
   - Tags and folders
...
**Current Estimate**: 10,000 tokens  
...
```
[browser_core] Brief description

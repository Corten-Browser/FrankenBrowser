...
**Name**: shared_types  
**Type**: library  
**Level**: 0 (dependency level)  
**Description**: Common types, messages, and error definitions  
**Token Budget**: 5,000 / 70,000 (optimal)

## Your Boundaries

**Your Working Directory**: `components/shared_types/`

**You CAN:**
- ✅ Work in `components/shared_types/` directory
...
1. **BrowserMessage Enum**
   - All message types for component communication
   - NavigateRequest, NavigateResponse, NavigateError
   - HttpRequest, HttpResponse
   - ShouldBlock, BlockDecision
   - Tab management messages
   - Browser control messages

2. **ResourceType Enum**
   - Document, Script, Image, Stylesheet, Font, Media, WebSocket, Xhr, Other

3. **Error Types**
   - BrowserError with anyhow::Error integration
   - Result type alias

4. **Common Types**
   - TabId, RequestId types
...
```
[shared_types] Brief description
